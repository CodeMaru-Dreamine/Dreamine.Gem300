...
public sealed class WorkflowTests
{
    ...
    public async Task CarrierToProcessToRemovalFlowPreservesEventOrder()
    {
        ...
        runtime.ControlJobs.Delete("CJ1"); runtime.ProcessJobs.Delete("PJ1");
    ...
    public async Task ProcessorFailureAbortsJobControlAndSubstrateWithoutSwallowingError()
    {
        ...
        runtime.ControlJobs.Delete("CJ1"); runtime.ProcessJobs.Delete("PJ1"); runtime.Substrates.Move("S1", "DST"); runtime.Workflow.ReleaseCarrier("C1");
    }
    ...
    private static void PrepareArrival(Gem300Runtime runtime)
    {
        ...
        runtime.Workflow.AcceptCarrier(new("P1", "C1", new[] { CarrierSlotState.CorrectlyOccupied }, new[] { new SubstrateArrivalPlan("S1", "SRC", "DST") }, new[] { new CarrierSubstrateSlotAssignment(0, "S1") }));
    }
